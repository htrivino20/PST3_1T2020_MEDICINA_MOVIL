...
public class MyFirebaseInstanceService extends FirebaseMessagingService {
    ...
    public void onNewToken(String s) {
        super.onNewToken(s); Log.d("TOKENFIREBASE",
                s);
    }
    @Override
    public void onMessageReceived(RemoteMessage remoteMessage) {
        ...
        System.out.println("nOTIFICAION DE "+from);
        System.out.println("Cuerpo de notificaion========>  "+remoteMessage.getNotification().getBody());
